...
TITLE Video Uploader - Pull Latest and Launch

REM ======================================================
REM        VIDEO UPLOADER - PULL LATEST AND LAUNCH ALL
REM ======================================================
REM This is the full launcher. It pulls the newest GitHub code,
REM checks dependencies, starts LM Studio support, starts backend,
REM starts frontend on port 8081, then opens the browser.
REM ======================================================
